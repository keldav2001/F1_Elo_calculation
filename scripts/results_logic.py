...
@bp.route(route="f1_results", auth_level=func.AuthLevel.ANONYMOUS)
def F1ResultsToBlob(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        for year in range(2000, 2026):
            url = f"https://api.jolpi.ca/ergast/f1/{year}/results?limit=1000"
            ...
            if res.status_code == 200:
                ...
                blob_name = f"results/year={year}/{year}_results.json"
